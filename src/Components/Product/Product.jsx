...
export default function Product() {
  return (
    <div>
      <div className="header2 d-flex align-items-center">
        <div className="container">
          <div className="">
            ...
            >
              اكتشف انواع السيارات واختيار <br></br>المناسبة اليك
            </p>
          </div>
        </div>
      </div>
      <div className="container">
        <div
          className="content1 d-flex small shadow justify-content-between mb-5 m-auto "
          style={{ direction: "rtl" }}
        >
          <div className="fw-bold border-end p-2">
            حجم السيارة <SlArrowDown style={{ color: "orange" }} />
          </div>
          <div className="fw-bold border-end p-2">
            فئة السيارة <SlArrowDown style={{ color: "orange" }} />
          </div>
          <div className="fw-bold border-end p-2">
            مانيوال / أوتوماتيك <SlArrowDown style={{ color: "orange" }} />
          </div>
          <div className="fw-bold border-end p-2">
            وقت و تاريخ التسليم
